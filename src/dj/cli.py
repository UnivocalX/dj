...
def parser(prog_name: str) -> dict:
    ...
    main_parser.add_argument("--registry-endpoint", type=str)
    main_parser.add_argument("--echo", action="store_const", const=True)
    main_parser.add_argument("--pool-size", type=int)
    main_parser.add_argument("--max-overflow", type=int)
